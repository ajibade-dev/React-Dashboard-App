...
const Notification = () => {
  const { currentColor, notification, setNotification } = useStateContext();

  return (
    <div className={notification ? 'hidden' : 'flex' }>
      ...
      <div className="flex justify-between items-center">
        ...
        <TooltipComponent content='Menu'position='BottomCenter'>
              ...
              <button type='button' onClick={ () => setNotification(!notification)} className='text-xl rounded-full p-3 hover:bg-light-gray mt-4 block'>
                <MdOutlineCancel />
              </button>
            </TooltipComponent>
      </div>
